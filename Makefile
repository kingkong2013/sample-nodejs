...
test:
	...
	@echo "make test-stubhub-ios       Test sample for StubHub iOS"
test-ios:
	macaca doctor
...
test-stubhub-ios:
	macaca doctor
	platform=ios macaca run --verbose --reporter macaca-reporter -d ./macaca-test/mobile-stubhub-app.test.js
.PHONY: test-ios
